export type Difficulty = "flat" | "hilly";
...
export const START_LOCATIONS: StartLocation[] = [
  { id: "monroe", name: "Monroe Park", x: 0.0, y: 0.0 },
  { id: "siegel", name: "Siegel Center", x: 0.15, y: 0.65 },
  { id: "vmfa", name: "VMFA", x: -1.36, y: 0.5 },
  { id: "carytown", name: "Carytown", x: -1.13, y: 0.21 },
  { id: "capitol", name: "Capitol Square", x: 0.92, y: -0.5 },
  { id: "maymont", name: "Maymont", x: -1.36, y: -0.7 },
  { id: "belle", name: "Belle Isle", x: 0.12, y: -0.92 },
  { id: "libby", name: "Libby Hill", x: 1.69, y: -1.28 },
  { id: "manchester", name: "Manchester", x: 0.65, y: -1.3 },
  { id: "scotts", name: "Scott's Addition", x: -0.95, y: 1.05 },
];

export const POIS: POI[] = [
  { id: "vmfa", name: "VMFA", x: -1.36, y: 0.5, difficulty: "flat", tags: ["museum"], blurb: "Free admission. The sculpture garden is the move." },
  ...
  { id: "maymont", name: "Maymont", x: -1.36, y: -0.7, difficulty: "hilly", tags: ["park", "scenic"], blurb: "Italian Garden, Japanese Garden, and a little farm." },
  { id: "capitol", name: "Capitol Square", x: 0.92, y: -0.5, difficulty: "flat", tags: ["history"], blurb: "Jefferson designed the building. Squirrels run the grounds." },
  ...
  { id: "forest-hill", name: "Forest Hill Park", x: -1.0, y: -1.3, difficulty: "hilly", tags: ["park", "scenic"], blurb: "Across the river. Saturday farmers market in season." },
  ...
  { id: "jefferson", name: "Jefferson Park", x: 1.8, y: -0.24, difficulty: "hilly", tags: ["park", "scenic"], blurb: "Best skyline view in the city. Hands down." },
  { id: "manch-flood", name: "Manchester Floodwall", x: 0.79, y: -1.3, difficulty: "flat", tags: ["river", "scenic"], blurb: "Long, wide, paved. River on one side, graffiti on the other." },
  ...
  { id: "battery", name: "Battery Park", x: 0.01, y: 1.8, difficulty: "hilly", tags: ["park"], blurb: "Northside neighborhood park with a real basketball scene." },
